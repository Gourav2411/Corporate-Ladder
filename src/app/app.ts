...
const SYNERGY_THRESHOLDS = [0, 100, 300, 600, 1200, 2500, 5000, 8000, 12000, 20000];
...
const LIFETIME_THRESHOLDS = [0, 1000, 5000, 15000, 35000, 75000, 150000, 300000, 750000, 1500000];

const STORY_EVENTS: Record<number, {title: string, text: string, boss: string}> = {
  100: { title: "The First Win", text: "You forwarded your first email chain. Welcome to the team. Time to climb.", boss: "Line Manager" },
  300: { title: "Performance Review", text: "You've survived enough useless meetings to justify an existence. Here's a new title. Keep up the aesthetic of hard work.", boss: "VP of Synergies" },
  1200: { title: "Welcome to Middle Management", text: "You don't do real work anymore. You manage the people who do. Fire them if they look at you funny. We've given you a company fleece.", boss: "The CEO" },
  5000: { title: "The Corner Office", text: "You did it. You took credit for everything. The golden parachute is secured. But there's always a bigger fish...", boss: "The Board" },
  12000: { title: "A Paradigm Shift", text: "You are no longer a person. You are a brand. You speak only in LinkedIn posts.", boss: "Your PR Manager" }
};
...
export const SKILL_TREE: SkillNode[] = [
   { id: 'coffee_boost', name: 'Premium Beans', desc: 'Coffee breaks last 2x as long.', cost: 500, icon: '☕', dependencies: [], type: 'passive' },
   { id: 'combo_retain', name: 'Retention Plan', desc: 'Combo meter drains 30% slower.', cost: 1200, icon: '🔥', dependencies: ['coffee_boost'], type: 'passive' },
   { id: 'action_gaslight', name: 'Gaslight Team', desc: 'New Action (G): Clear all obstacles on screen. Costs 40 Morale.', cost: 3000, icon: '💨', dependencies: ['combo_retain'], type: 'action', keyCode: 'G' },
   { id: 'marketing_buzz', name: 'Buzzwords', desc: 'Passively generate +1 Synergy every second.', cost: 800, icon: '📈', dependencies: [], type: 'passive' },
   { id: 'viral_referral', name: 'Affiliate Marketing', desc: 'Double Synergy points gained from Daily Objectives.', cost: 1500, icon: '🔗', dependencies: ['marketing_buzz'], type: 'passive' },
   { id: 'viral_influencer', name: 'LinkedIn Influencer', desc: 'Gain +2 Synergy passively every second. Unlocks elite title.', cost: 4000, icon: '🤳', dependencies: ['viral_referral'], type: 'passive' },
   { id: 'action_synergize_aoe', name: 'Reply All', desc: 'Synergize Email (E) clears ALL emails on screen.', cost: 2500, icon: '📧', dependencies: ['marketing_buzz'], type: 'passive', keyCode: 'E' },
   { id: 'skill_growth_hacking_0', name: 'Growth Hacking', desc: 'Increases global Synergy multiplier by 0.5%.', cost: 8200, icon: '📅', dependencies: ['action_synergize_aoe'], type: 'passive' },
   { id: 'skill_disruptive_innovation_1', name: 'Disruptive Innovation', desc: 'Increases global Synergy multiplier by 0.7%.', cost: 8050, icon: '📅', dependencies: ['coffee_boost'], type: 'passive' },
   { id: 'skill_blockchain_integration_2', name: 'Blockchain Integration', desc: 'Increases global Synergy multiplier by 0.5%.', cost: 7412, icon: '📅', dependencies: ['action_synergize_aoe'], type: 'passive' },
   { id: 'skill_agile_transformation_3', name: 'Agile Transformation', desc: 'Increases global Synergy multiplier by 0.2%.', cost: 7787, icon: '🚀', dependencies: ['marketing_buzz'], type: 'passive' },
   { id: 'skill_six_sigma_black_belt_4', name: 'Six Sigma Black Belt', desc: 'Increases global Synergy multiplier by 0.9%.', cost: 10476, icon: '💼', dependencies: ['skill_blockchain_integration_2'], type: 'passive' },
   { id: 'skill_bleeding_edge_insights_5', name: 'Bleeding Edge Insights', desc: 'Increases global Synergy multiplier by 0.7%.', cost: 10479, icon: '📋', dependencies: ['skill_agile_transformation_3'], type: 'passive' },
   { id: 'skill_thought_leadership_6', name: 'Thought Leadership', desc: 'Increases global Synergy multiplier by 0.8%.', cost: 10697, icon: '💼', dependencies: ['action_synergize_aoe'], type: 'passive' },
   { id: 'skill_holistic_approach_7', name: 'Holistic Approach', desc: 'Increases global Synergy multiplier by 0.5%.', cost: 11831, icon: '💡', dependencies: ['skill_six_sigma_black_belt_4'], type: 'passive' },
   { id: 'skill_paradigm_shift_8', name: 'Paradigm Shift', desc: 'Increases global Synergy multiplier by 0.9%.', cost: 9082, icon: '🗑️', dependencies: ['skill_thought_leadership_6'], type: 'passive' },
   { id: 'skill_pivot_strategy_9', name: 'Pivot Strategy', desc: 'Increases global Synergy multiplier by 0.3%.', cost: 8051, icon: '🚀', dependencies: ['skill_disruptive_innovation_1'], type: 'passive' },
   { id: 'skill_blue_ocean_strategy_10', name: 'Blue Ocean Strategy', desc: 'Increases global Synergy multiplier by 0.9%.', cost: 12238, icon: '📋', dependencies: ['skill_paradigm_shift_8'], type: 'passive' },
   { id: 'skill_core_competencies_11', name: 'Core Competencies', desc: 'Increases global Synergy multiplier by 0.9%.', cost: 12344, icon: '📉', dependencies: ['skill_blue_ocean_strategy_10'], type: 'passive' },
   { id: 'skill_wheelhouse_optimization_12', name: 'Wheelhouse Optimization', desc: 'Increases global Synergy multiplier by 0.2%.', cost: 13171, icon: '🤝', dependencies: ['skill_bleeding_edge_insights_5'], type: 'passive' },
   { id: 'skill_boil_the_ocean_13', name: 'Boil the Ocean', desc: 'Increases global Synergy multiplier by 0.7%.', cost: 10619, icon: '💰', dependencies: ['skill_pivot_strategy_9'], type: 'passive' },
   { id: 'skill_low_hanging_fruit_14', name: 'Low Hanging Fruit', desc: 'Increases global Synergy multiplier by 0.3%.', cost: 14489, icon: '💼', dependencies: ['skill_holistic_approach_7'], type: 'passive' },
   { id: 'skill_wheel_reinvention_15', name: 'Wheel Reinvention', desc: 'Increases global Synergy multiplier by 0.10%.', cost: 11983, icon: '🏢', dependencies: ['skill_holistic_approach_7'], type: 'passive' },
   { id: 'skill_deep_dive_16', name: 'Deep Dive', desc: 'Increases global Synergy multiplier by 0.1%.', cost: 15202, icon: '📉', dependencies: ['skill_pivot_strategy_9'], type: 'passive' },
   { id: 'skill_bandwidth_expansion_17', name: 'Bandwidth Expansion', desc: 'Increases global Synergy multiplier by 0.8%.', cost: 12247, icon: '🚀', dependencies: ['skill_wheel_reinvention_15'], type: 'passive' },
   { id: 'skill_circle_back_18', name: 'Circle Back', desc: 'Increases global Synergy multiplier by 0.4%.', cost: 13619, icon: '💼', dependencies: ['skill_low_hanging_fruit_14'], type: 'passive' },
   { id: 'skill_ping_protocol_19', name: 'Ping Protocol', desc: 'Increases global Synergy multiplier by 0.2%.', cost: 14919, icon: '💼', dependencies: ['skill_deep_dive_16'], type: 'passive' },
   { id: 'skill_take_offline_20', name: 'Take Offline', desc: 'Increases global Synergy multiplier by 0.3%.', cost: 16149, icon: '📅', dependencies: ['skill_low_hanging_fruit_14'], type: 'passive' },
   { id: 'skill_actionable_insights_21', name: 'Actionable Insights', desc: 'Increases global Synergy multiplier by 0.2%.', cost: 17711, icon: '💼', dependencies: ['skill_circle_back_18'], type: 'passive' },
   { id: 'skill_big_data_mining_22', name: 'Big Data Mining', desc: 'Increases global Synergy multiplier by 0.2%.', cost: 17006, icon: '🚀', dependencies: ['skill_bandwidth_expansion_17'], type: 'passive' },
   { id: 'skill_cloud_native_workflow_23', name: 'Cloud Native Workflow', desc: 'Increases global Synergy multiplier by 0.2%.', cost: 15536, icon: '👔', dependencies: ['skill_big_data_mining_22'], type: 'passive' },
   { id: 'skill_value_add_24', name: 'Value Add', desc: 'Increases global Synergy multiplier by 0.8%.', cost: 16302, icon: '⏱️', dependencies: ['skill_circle_back_18'], type: 'passive' },
   { id: 'skill_game_changer_25', name: 'Game Changer', desc: 'Increases global Synergy multiplier by 0.3%.', cost: 17707, icon: '⏱️', dependencies: ['skill_actionable_insights_21'], type: 'passive' },
   { id: 'skill_win_win_scenario_26', name: 'Win-Win Scenario', desc: 'Increases global Synergy multiplier by 0.6%.', cost: 18352, icon: '💡', dependencies: ['skill_big_data_mining_22'], type: 'passive' },
   { id: 'skill_hyperlocal_targeting_27', name: 'Hyperlocal Targeting', desc: 'Increases global Synergy multiplier by 0.3%.', cost: 22939, icon: '🤝', dependencies: ['skill_take_offline_20'], type: 'passive' },
   { id: 'skill_omnichannel_execution_28', name: 'Omnichannel Execution', desc: 'Increases global Synergy multiplier by 0.5%.', cost: 24070, icon: '📋', dependencies: ['skill_hyperlocal_targeting_27'], type: 'passive' },
   { id: 'skill_touchplot_sync_29', name: 'Touchplot Sync', desc: 'Increases global Synergy multiplier by 0.4%.', cost: 22448, icon: '📊', dependencies: ['skill_game_changer_25'], type: 'passive' },
   { id: 'skill_north_star_alignment_30', name: 'North Star Alignment', desc: 'Increases global Synergy multiplier by 0.6%.', cost: 23875, icon: '👔', dependencies: ['skill_value_add_24'], type: 'passive' },
   { id: 'skill_key_deliverables_31', name: 'Key Deliverables', desc: 'Increases global Synergy multiplier by 0.9%.', cost: 23253, icon: '📈', dependencies: ['skill_win_win_scenario_26'], type: 'passive' },
   { id: 'skill_silo_busting_32', name: 'Silo Busting', desc: 'Increases global Synergy multiplier by 0.4%.', cost: 25285, icon: '🚀', dependencies: ['skill_key_deliverables_31'], type: 'passive' },
   { id: 'skill_cross_functional_synergy_33', name: 'Cross-functional Synergy', desc: 'Increases global Synergy multiplier by 0.4%.', cost: 27274, icon: '🏢', dependencies: ['skill_game_changer_25'], type: 'passive' },
   { id: 'skill_scalable_solutions_34', name: 'Scalable Solutions', desc: 'Increases global Synergy multiplier by 0.2%.', cost: 29922, icon: '💡', dependencies: ['skill_silo_busting_32'], type: 'passive' },
   { id: 'skill_optics_management_35', name: 'Optics Management', desc: 'Increases global Synergy multiplier by 0.3%.', cost: 28733, icon: '📅', dependencies: ['skill_key_deliverables_31'], type: 'passive' },
   { id: 'skill_bandwidth_reallocation_36', name: 'Bandwidth Reallocation', desc: 'Increases global Synergy multiplier by 0.5%.', cost: 31109, icon: '💰', dependencies: ['skill_touchplot_sync_29'], type: 'passive' },
   { id: 'skill_stakeholder_alignment_37', name: 'Stakeholder Alignment', desc: 'Increases global Synergy multiplier by 0.10%.', cost: 34554, icon: '👔', dependencies: ['skill_key_deliverables_31'], type: 'passive' },
   { id: 'skill_roi_maximization_38', name: 'ROI Maximization', desc: 'Increases global Synergy multiplier by 0.10%.', cost: 32671, icon: '📅', dependencies: ['skill_key_deliverables_31'], type: 'passive' },
   { id: 'skill_kpi_crushing_39', name: 'KPI Crushing', desc: 'Increases global Synergy multiplier by 0.3%.', cost: 36864, icon: '📅', dependencies: ['skill_cross_functional_synergy_33'], type: 'passive' },
   { id: 'skill_data_driven_decisions_40', name: 'Data-Driven Decisions', desc: 'Increases global Synergy multiplier by 0.4%.', cost: 37037, icon: '📅', dependencies: ['skill_roi_maximization_38'], type: 'passive' },
   { id: 'skill_customer_centricity_41', name: 'Customer Centricity', desc: 'Increases global Synergy multiplier by 0.4%.', cost: 36893, icon: '📋', dependencies: ['skill_optics_management_35'], type: 'passive' },
   { id: 'skill_market_penetration_42', name: 'Market Penetration', desc: 'Increases global Synergy multiplier by 0.6%.', cost: 42837, icon: '🤝', dependencies: ['skill_data_driven_decisions_40'], type: 'passive' },
   { id: 'skill_first_mover_advantage_43', name: 'First Mover Advantage', desc: 'Increases global Synergy multiplier by 0.1%.', cost: 43573, icon: '📋', dependencies: ['skill_customer_centricity_41'], type: 'passive' },
   { id: 'skill_b2b_dynamics_44', name: 'B2B Dynamics', desc: 'Increases global Synergy multiplier by 0.9%.', cost: 46206, icon: '🤝', dependencies: ['skill_bandwidth_reallocation_36'], type: 'passive' },
   { id: 'skill_b2c_outreach_45', name: 'B2C Outreach', desc: 'Increases global Synergy multiplier by 0.8%.', cost: 49241, icon: '📋', dependencies: ['skill_roi_maximization_38'], type: 'passive' },
   { id: 'skill_growth_mindset_46', name: 'Growth Mindset', desc: 'Increases global Synergy multiplier by 0.9%.', cost: 49183, icon: '🤝', dependencies: ['skill_first_mover_advantage_43'], type: 'passive' },
   { id: 'skill_ideation_session_47', name: 'Ideation Session', desc: 'Increases global Synergy multiplier by 0.3%.', cost: 52837, icon: '📉', dependencies: ['skill_growth_mindset_46'], type: 'passive' },
   { id: 'skill_mindshare_capture_48', name: 'Mindshare Capture', desc: 'Increases global Synergy multiplier by 0.3%.', cost: 54408, icon: '🧠', dependencies: ['skill_customer_centricity_41'], type: 'passive' },
   { id: 'skill_strategic_alliance_49', name: 'Strategic Alliance', desc: 'Increases global Synergy multiplier by 0.6%.', cost: 58203, icon: '🤝', dependencies: ['skill_b2b_dynamics_44'], type: 'passive' },
   { id: 'skill_leverage_assets_50', name: 'Leverage Assets', desc: 'Increases global Synergy multiplier by 0.5%.', cost: 60828, icon: '🧠', dependencies: ['skill_first_mover_advantage_43'], type: 'passive' },
   { id: 'skill_monetization_engine_51', name: 'Monetization Engine', desc: 'Increases global Synergy multiplier by 0.6%.', cost: 61089, icon: '📋', dependencies: ['skill_first_mover_advantage_43'], type: 'passive' },
   { id: 'skill_future_proofing_52', name: 'Future-Proofing', desc: 'Increases global Synergy multiplier by 0.2%.', cost: 67693, icon: '🚀', dependencies: ['skill_leverage_assets_50'], type: 'passive' },
   { id: 'skill_mission_critical_53', name: 'Mission Critical', desc: 'Increases global Synergy multiplier by 0.2%.', cost: 68347, icon: '🏢', dependencies: ['skill_ideation_session_47'], type: 'passive' },
   { id: 'skill_return_on_investment_54', name: 'Return on Investment', desc: 'Increases global Synergy multiplier by 0.1%.', cost: 71059, icon: '📊', dependencies: ['skill_mindshare_capture_48'], type: 'passive' },
   { id: 'skill_skin_in_the_game_55', name: 'Skin in the Game', desc: 'Increases global Synergy multiplier by 0.5%.', cost: 76236, icon: '🤝', dependencies: ['skill_leverage_assets_50'], type: 'passive' },
   { id: 'skill_sweat_equity_56', name: 'Sweat Equity', desc: 'Increases global Synergy multiplier by 0.4%.', cost: 81587, icon: '🧠', dependencies: ['skill_mindshare_capture_48'], type: 'passive' },
   { id: 'skill_move_the_needle_57', name: 'Move the Needle', desc: 'Increases global Synergy multiplier by 0.2%.', cost: 82221, icon: '🧠', dependencies: ['skill_leverage_assets_50'], type: 'passive' },
   { id: 'skill_outside_the_box_58', name: 'Outside the Box', desc: 'Increases global Synergy multiplier by 0.2%.', cost: 86247, icon: '📋', dependencies: ['skill_future_proofing_52'], type: 'passive' },
   { id: 'skill_thought_shower_59', name: 'Thought Shower', desc: 'Increases global Synergy multiplier by 0.4%.', cost: 89474, icon: '📋', dependencies: ['skill_sweat_equity_56'], type: 'passive' },
   { id: 'skill_brain_dump_60', name: 'Brain Dump', desc: 'Increases global Synergy multiplier by 0.7%.', cost: 95512, icon: '📅', dependencies: ['skill_outside_the_box_58'], type: 'passive' },
   { id: 'skill_drill_down_61', name: 'Drill Down', desc: 'Increases global Synergy multiplier by 0.1%.', cost: 101972, icon: '🧠', dependencies: ['skill_return_on_investment_54'], type: 'passive' },
   { id: 'skill_scope_creep_management_62', name: 'Scope Creep Management', desc: 'Increases global Synergy multiplier by 0.8%.', cost: 105365, icon: '📋', dependencies: ['skill_brain_dump_60'], type: 'passive' },
   { id: 'skill_right_sizing_63', name: 'Right-sizing', desc: 'Increases global Synergy multiplier by 0.8%.', cost: 109603, icon: '💰', dependencies: ['skill_thought_shower_59'], type: 'passive' },
   { id: 'skill_downsizing_64', name: 'Downsizing', desc: 'Increases global Synergy multiplier by 0.6%.', cost: 114598, icon: '🤝', dependencies: ['skill_outside_the_box_58'], type: 'passive' },
   { id: 'skill_restructuring_65', name: 'Restructuring', desc: 'Increases global Synergy multiplier by 0.7%.', cost: 119362, icon: '📈', dependencies: ['skill_drill_down_61'], type: 'passive' },
   { id: 'skill_vertical_integration_66', name: 'Vertical Integration', desc: 'Increases global Synergy multiplier by 0.4%.', cost: 128310, icon: '🤝', dependencies: ['skill_thought_shower_59'], type: 'passive' },
   { id: 'skill_horizontal_scaling_67', name: 'Horizontal Scaling', desc: 'Increases global Synergy multiplier by 0.9%.', cost: 132955, icon: '🗑️', dependencies: ['skill_right_sizing_63'], type: 'passive' },
   { id: 'skill_360_degree_feedback_68', name: '360-Degree Feedback', desc: 'Increases global Synergy multiplier by 0.5%.', cost: 138812, icon: '💼', dependencies: ['skill_drill_down_61'], type: 'passive' },
   { id: 'skill_open_door_policy_69', name: 'Open Door Policy', desc: 'Increases global Synergy multiplier by 0.7%.', cost: 149397, icon: '💡', dependencies: ['skill_downsizing_64'], type: 'passive' },
   { id: 'skill_culture_fit_70', name: 'Culture Fit', desc: 'Increases global Synergy multiplier by 0.4%.', cost: 151826, icon: '📊', dependencies: ['skill_scope_creep_management_62'], type: 'passive' },
   { id: 'skill_onboarding_optimization_71', name: 'Onboarding Optimization', desc: 'Increases global Synergy multiplier by 0.2%.', cost: 162517, icon: '⏱️', dependencies: ['skill_360_degree_feedback_68'], type: 'passive' },
   { id: 'skill_offboarding_streamlining_72', name: 'Offboarding Streamlining', desc: 'Increases global Synergy multiplier by 0.7%.', cost: 168687, icon: '🚀', dependencies: ['skill_culture_fit_70'], type: 'passive' },
   { id: 'skill_talent_acquisition_73', name: 'Talent Acquisition', desc: 'Increases global Synergy multiplier by 0.3%.', cost: 178456, icon: '💡', dependencies: ['skill_open_door_policy_69'], type: 'passive' },
   { id: 'skill_headcount_management_74', name: 'Headcount Management', desc: 'Increases global Synergy multiplier by 0.10%.', cost: 185443, icon: '💼', dependencies: ['skill_culture_fit_70'], type: 'passive' },
   { id: 'skill_freemium_model_75', name: 'Freemium Model', desc: 'Increases global Synergy multiplier by 0.7%.', cost: 198170, icon: '📉', dependencies: ['skill_horizontal_scaling_67'], type: 'passive' },
   { id: 'skill_a_b_testing_76', name: 'A/B Testing', desc: 'Increases global Synergy multiplier by 0.2%.', cost: 206458, icon: '🏢', dependencies: ['skill_freemium_model_75'], type: 'passive' },
   { id: 'skill_growth_loop_77', name: 'Growth Loop', desc: 'Increases global Synergy multiplier by 0.5%.', cost: 214230, icon: '📊', dependencies: ['skill_culture_fit_70'], type: 'passive' },
   { id: 'skill_viral_coefficient_78', name: 'Viral Coefficient', desc: 'Increases global Synergy multiplier by 0.5%.', cost: 226511, icon: '📋', dependencies: ['skill_onboarding_optimization_71'], type: 'passive' },
   { id: 'skill_churn_reduction_79', name: 'Churn Reduction', desc: 'Increases global Synergy multiplier by 0.2%.', cost: 235826, icon: '📅', dependencies: ['skill_viral_coefficient_78'], type: 'passive' },
   { id: 'skill_ltv_maximization_80', name: 'LTV Maximization', desc: 'Increases global Synergy multiplier by 0.7%.', cost: 251302, icon: '🤝', dependencies: ['skill_headcount_management_74'], type: 'passive' },
   { id: 'skill_cac_optimization_81', name: 'CAC Optimization', desc: 'Increases global Synergy multiplier by 0.5%.', cost: 260267, icon: '🧠', dependencies: ['skill_growth_loop_77'], type: 'passive' },
   { id: 'skill_funnel_conversion_82', name: 'Funnel Conversion', desc: 'Increases global Synergy multiplier by 0.1%.', cost: 276550, icon: '🏢', dependencies: ['skill_headcount_management_74'], type: 'passive' },
   { id: 'skill_bounce_rate_minimization_83', name: 'Bounce Rate Minimization', desc: 'Increases global Synergy multiplier by 0.9%.', cost: 287882, icon: '🚀', dependencies: ['skill_freemium_model_75'], type: 'passive' },
   { id: 'skill_net_promoter_score_84', name: 'Net Promoter Score', desc: 'Increases global Synergy multiplier by 0.8%.', cost: 301196, icon: '🚀', dependencies: ['skill_growth_loop_77'], type: 'passive' },
   { id: 'skill_customer_journey_85', name: 'Customer Journey', desc: 'Increases global Synergy multiplier by 0.6%.', cost: 319725, icon: '💼', dependencies: ['skill_growth_loop_77'], type: 'passive' },
   { id: 'skill_user_flow_86', name: 'User Flow', desc: 'Increases global Synergy multiplier by 0.8%.', cost: 335606, icon: '📈', dependencies: ['skill_customer_journey_85'], type: 'passive' },
   { id: 'skill_ui_ux_enhancement_87', name: 'UI/UX Enhancement', desc: 'Increases global Synergy multiplier by 0.9%.', cost: 349376, icon: '🗑️', dependencies: ['skill_bounce_rate_minimization_83'], type: 'passive' },
   { id: 'skill_design_thinking_88', name: 'Design Thinking', desc: 'Increases global Synergy multiplier by 0.8%.', cost: 366974, icon: '📈', dependencies: ['skill_cac_optimization_81'], type: 'passive' },
   { id: 'skill_minimum_viable_product_89', name: 'Minimum Viable Product', desc: 'Increases global Synergy multiplier by 0.8%.', cost: 386042, icon: '📅', dependencies: ['skill_cac_optimization_81'], type: 'passive' },
   { id: 'skill_product_market_fit_90', name: 'Product Market Fit', desc: 'Increases global Synergy multiplier by 0.6%.', cost: 403424, icon: '📋', dependencies: ['skill_customer_journey_85'], type: 'passive' },
   { id: 'skill_iteration_velocity_91', name: 'Iteration Velocity', desc: 'Increases global Synergy multiplier by 0.4%.', cost: 427365, icon: '🤝', dependencies: ['skill_net_promoter_score_84'], type: 'passive' },
   { id: 'skill_pivot_to_video_92', name: 'Pivot to Video', desc: 'Increases global Synergy multiplier by 0.1%.', cost: 448113, icon: '📉', dependencies: ['skill_ui_ux_enhancement_87'], type: 'passive' },
   { id: 'skill_metaverse_integration_93', name: 'Metaverse Integration', desc: 'Increases global Synergy multiplier by 0.2%.', cost: 467318, icon: '📋', dependencies: ['skill_minimum_viable_product_89'], type: 'passive' },
   { id: 'skill_web3_strategy_94', name: 'Web3 Strategy', desc: 'Increases global Synergy multiplier by 0.3%.', cost: 489933, icon: '⏱️', dependencies: ['skill_metaverse_integration_93'], type: 'passive' },
   { id: 'skill_ai_driven_development_95', name: 'AI-Driven Development', desc: 'Increases global Synergy multiplier by 0.6%.', cost: 518314, icon: '💼', dependencies: ['skill_minimum_viable_product_89'], type: 'passive' },
   { id: 'skill_machine_learning_pipeline_96', name: 'Machine Learning Pipeline', desc: 'Increases global Synergy multiplier by 0.7%.', cost: 540919, icon: '💰', dependencies: ['skill_design_thinking_88'], type: 'passive' },
   { id: 'skill_quantum_readiness_97', name: 'Quantum Readiness', desc: 'Increases global Synergy multiplier by 0.2%.', cost: 569709, icon: '💡', dependencies: ['skill_product_market_fit_90'], type: 'passive' },
   { id: 'skill_neural_network_scaling_98', name: 'Neural Network Scaling', desc: 'Increases global Synergy multiplier by 0.9%.', cost: 596449, icon: '🗑️', dependencies: ['skill_pivot_to_video_92'], type: 'passive' },
   { id: 'skill_llm_prompt_engineering_99', name: 'LLM Prompt Engineering', desc: 'Increases global Synergy multiplier by 0.8%.', cost: 629706, icon: '🚀', dependencies: ['skill_neural_network_scaling_98'], type: 'passive' }
];
...
export class App implements OnDestroy {
  ...
  levelIndex = computed(() => {
    ...
    if (level > this.highestLevelEver()) {
       setTimeout(() => {
           ...
           if (typeof window !== 'undefined') localStorage.setItem('corp_highest_level', level.toString());
       }, 0);
    }
  ...
  progressToNextLevel = computed(() => {
    ...
    return Math.min(100, Math.max(0, Math.floor(((this.synergy() - currentBase) / (threshold - currentBase)) * 100)));
  });
  ...
  availableSkins = [
      {id: 'classic', name: 'Standard Issue Suit', desc: 'The corporate default.', unlockLevel: 0},
      {id: 'fleece', name: 'Tech Bro Fleece', desc: 'For when you want to seem approachable.', unlockLevel: 2},
      {id: 'gold', name: 'Executive Gold', desc: 'Reserved for the C-Suite.', unlockLevel: 5},
      {id: 'cyber', name: 'Neon Disruptor', desc: 'Move fast, break things.', unlockLevel: 8},
  ...
  confetti: {x: number, y: number, vx: number, vy: number, color: string, ang: number, vAng: number}[] = [];
  ...
  private GAME_ACTIONS = [
    ...
    { type: 'giveVagueDirection', icon: '😶‍🌫️', color: '#EF4444', text: 'Direction' },
    { type: 'scheduleUselessMeeting', icon: '🗓️', color: '#2563EB', text: 'Meeting' },
    ...
    { type: 'brainstormingSession', icon: '💡', color: '#2563EB', text: 'Brainstorm' },
    { type: 'fakeCollaboration', icon: '🤝', color: '#2DD4BF', text: 'Fake Collab' }
  ];

  private HURDLES = [
    { type: 'redTape', icon: '🛑', color: '#EF4444', text: 'Red Tape', width: 90, speedModifier: 0.7 },
    { type: 'urgentEmail', icon: '📧', color: '#EAB308', text: 'Email', width: 36, speedModifier: 1.2 },
    { type: 'realWork', icon: '💻', color: '#EF4444', text: 'Coding', width: 36, speedModifier: 1 },
    { type: 'realWork', icon: '📄', color: '#EF4444', text: 'Strategy', width: 36, speedModifier: 1 },
    { type: 'realWork', icon: '📈', color: '#EF4444', text: 'Marketing', width: 36, speedModifier: 1 },
    { type: 'realWork', icon: '📊', color: '#EF4444', text: 'QA Testing', width: 36, speedModifier: 1.1 },
    { type: 'micromanager', icon: '🕵️', color: '#7C3AED', text: 'Micromanager', width: 45, speedModifier: 0.8 },
    { type: 'endlessMeeting', icon: '📅', color: '#3B82F6', text: 'Endless Meeting', width: 120, speedModifier: 0.6 }
  ];

  isPaused = false;
  private projectiles: {x: number, y: number, width: number, height: number, speed: number}[] = [];
  private blocks: {x: number, y: number, width: number, height: number, active: boolean}[] = [];
  ...
  constructor() {
    ...
    effect(() => {
      ...
      if (currentMorale <= 0) {
        setTimeout(() => {
          this.addLog("Your team's morale hit 0%. Upper management loves your 'tough decisions'. Synergy boosted!", 'success');
      ...
      if (currentBusyness >= 100) {
        setTimeout(() => {
          this.addLog("You looked extremely busy today. Perception is reality! Synergy +20", 'success');
  ...
  updateConfetti() {
    for (let i = this.confetti.length - 1; i >= 0; i--) {
      ...
      c.vy += 0.2; // gravity
      c.ang += c.vAng;
      if (typeof window !== 'undefined' && this.canvasRef && c.y > this.canvasRef.nativeElement.height) {
  ...
  addLog(message: string, type: 'info' | 'success' | 'warning' | 'error' = 'info') {
    this.trackAnalytics('game_activity', { message, log_type: type, current_synergy: this.synergy(), title: this.currentTitle() });
  ...
  stareAtDeck() {
    ...
    this.addCombo(10);
    this.addLog("Stared intensely at a 90-page slide deck. Didn't read a word.", 'info');
  ...
  takeCredit() {
    if (this.teamMorale() < 30) {
      this.addLog("Team morale is too low to take credit. They are actively complaining.", 'error');
      return;
    }
    ...
    this.addCombo(50);
    this.addLog("Presented your team's hard work as your own. Executive leadership is impressed!", 'success');
    this.updateQuest('take_credit');
  }

  fakeCollaboration() {
    this.runStats['fakeCollaboration'] = (this.runStats['fakeCollaboration'] || 0) + 1;
    this.busyness.update(b => Math.min(100, b + 10));
    this.teamMorale.update(m => Math.max(0, m - 5));
    this.addCombo(15);
    this.addLog("Engaged in 'fake collaboration' with another department. Nothing was accomplished, but perceptions are managed.", 'info');
  ...
  fireTeamMember() {
    ...
    this.synergy.update(s => s + (10 * this.comboMultiplier));
    this.addCombo(20);
    this.addLog("Successfully terminated a high-performing employee. Your decisiveness is noted.", 'success');
  ...
  scheduleUselessMeeting() {
    this.runStats['scheduleUselessMeeting'] = (this.runStats['scheduleUselessMeeting'] || 0) + 1;
    ...
    this.addCombo(20);
    this.addLog("Scheduled a 2-hour 'Sync-up' meeting that could have been an email.", 'warning');
    this.updateQuest('meeting');
  }

  giveVagueDirection() {
    this.runStats['giveVagueDirection'] = (this.runStats['giveVagueDirection'] || 0) + 1;
    this.synergy.update(s => s + (5 * this.comboMultiplier));
    this.busyness.update(b => Math.min(100, b + 10));
    this.teamMorale.update(m => Math.max(0, m - 15));
    this.addCombo(10);
    this.addLog("Told the team to 'make it pop' and 'think outside the box'.", 'warning');
    this.updateQuest('vague');
  }

  networkingLunch() {
    this.runStats['networkingLunch'] = (this.runStats['networkingLunch'] || 0) + 1;
    this.synergy.update(s => s + (20 * this.comboMultiplier));
    this.busyness.update(b => Math.max(0, b - 15));
    this.addCombo(20);
    this.addLog("Attended a networking lunch. Exchanged business cards with a VP. High-level synergy achieved!", 'success');
    this.updateQuest('network');
  }

  mentoringSession() {
    this.runStats['mentoringSession'] = (this.runStats['mentoringSession'] || 0) + 1;
    this.teamMorale.update(m => Math.min(100, m + 10));
    this.synergy.update(s => Math.max(0, s - 5));
    this.addLog('Held a "mentoring session" where you mainly talked about yourself. Team feels slightly more motivated, but confused.', 'info');
  ...
  synergyWorkshop() {
    this.runStats['synergyWorkshop'] = (this.runStats['synergyWorkshop'] || 0) + 1;
    this.synergy.update(s => s + (25 * this.comboMultiplier));
    this.busyness.update(b => Math.max(0, b - 10));
    this.addCombo(30);
    this.addLog("Conducted a 'synergy workshop' focusing on abstract concepts. Everyone left feeling more 'aligned'.", 'success');
    this.updateQuest('workshop');
  }

  brainstormingSession() {
    this.runStats['brainstormingSession'] = (this.runStats['brainstormingSession'] || 0) + 1;
    this.busyness.update(b => Math.min(100, b + 10));
    this.teamMorale.update(m => Math.max(0, m - 5));
    this.addCombo(15);
    this.addLog("Held a 'brainstorming session' that was mostly you asking for ideas. The team provided them.", 'info');
  ...
  fallbackCopy(text: string, inputElement?: HTMLInputElement) {
     if (inputElement) {
        ...
        this.addLog("Copy API unavailable. Please select and copy manually.", "warning");
     }
  }
  ...
  finishTutorial() {
      if (typeof window !== 'undefined') localStorage.setItem('corp_tutorial_done', 'true');
      this.actuallyStartGame();
  }
  ...
  listenToRoom(roomId: string) {
     ...
     this.roomSub = onSnapshot(doc(db, 'multiplayer_rooms', roomId), (snap) => {
        if (snap.exists()) {
           ...
           if (data.status === 'playing' && this.gameState() === 'multiplayer_lobby') {
  ...
  executeSabotage(targetUid: string, type: 'email_wall' | 'freeze', cost: number) {
     ...
     this.spawnFloatingText(`SENT SABOTAGE! (-${cost})`, '#D946EF', this.player.x, this.player.y - 40);
     this.addLog(`Sabotaged opponent with ${typeName}!`, 'warning');
  }

  triggerSabotage(type: string, senderName: string) {
     this.spawnFloatingText(`SABOTAGE FROM ${senderName.toUpperCase()}!`, '#EF4444', 400, 300);
     ...
     if (type === 'email_wall') {
        ...
        for (let i = 0; i < 5; i++) {
           this.obstacles.push({
              ...
              isHurdle: true,
              collected: false,
              action: { type: 'urgentEmail', icon: '📧', color: '#EF4444', text: 'URGENT EMAIL WALL!' }
           });
        }
     } else if (type === 'freeze') {
        this.screenShake = 20;
  ...
  generateQuests() {
     const pool = [
        { type: 'fire', desc: 'Fire Doers', target: 3, progress: 0, reward: 500, completed: false },
        { type: 'fire_many', desc: 'Clean House', target: 10, progress: 0, reward: 2000, completed: false },
        { type: 'fire_cause', desc: 'Fire without cause', target: 2, progress: 0, reward: 500, completed: false },
        { type: 'meeting', desc: 'Attend pointless meeting', target: 2, progress: 0, reward: 250, completed: false },
        { type: 'coffee', desc: 'Drink Coffees', target: 2, progress: 0, reward: 250, completed: false },
        { type: 'coffee_addict', desc: 'Coffee Addict', target: 8, progress: 0, reward: 1000, completed: false },
        { type: 'emails', desc: 'Clear Urgent Emails', target: 5, progress: 0, reward: 300, completed: false },
        { type: 'inbox_zero', desc: 'Inbox Zero Pursuit', target: 20, progress: 0, reward: 2500, completed: false },
        { type: 'jump', desc: 'Jump over hurdles', target: 15, progress: 0, reward: 150, completed: false },
        { type: 'jump_high', desc: 'Acrobatic Manager', target: 50, progress: 0, reward: 600, completed: false },
        { type: 'kissup', desc: 'Bootlick Management', target: 3, progress: 0, reward: 800, completed: false },
        { type: 'deck', desc: 'Stare at Slide Deck', target: 4, progress: 0, reward: 350, completed: false },
        { type: 'network', desc: 'Networking Lunch', target: 2, progress: 0, reward: 400, completed: false },
        { type: 'empathy', desc: 'Offer Fake Empathy', target: 3, progress: 0, reward: 600, completed: false },
        { type: 'expenses', desc: 'Approve Expenses', target: 5, progress: 0, reward: 750, completed: false },
        { type: 'workshop', desc: 'Synergy Workshop', target: 2, progress: 0, reward: 600, completed: false },
        { type: 'brainstorm', desc: 'Brainstorm Session', target: 3, progress: 0, reward: 500, completed: false },
        { type: 'delegate', desc: 'Delegate Tasks', target: 5, progress: 0, reward: 900, completed: false },
        { type: 'mentor', desc: 'Mentoring Session', target: 1, progress: 0, reward: 300, completed: false },
        { type: 'collab', desc: 'Fake Collaboration', target: 4, progress: 0, reward: 550, completed: false },
        { type: 'gaslight', desc: 'Gaslight Team', target: 1, progress: 0, reward: 1000, completed: false },
        { type: 'gaslight_pro', desc: 'Master Gaslighter', target: 3, progress: 0, reward: 4000, completed: false },
        { type: 'ping', desc: 'Ping for Thoughts', target: 3, progress: 0, reward: 400, completed: false },
        { type: 'circle_back', desc: 'Circle Back later', target: 4, progress: 0, reward: 500, completed: false },
        { type: 'take_credit', desc: 'Take Credit for work', target: 2, progress: 0, reward: 800, completed: false },
        { type: 'vague', desc: 'Give Vague Directions', target: 3, progress: 0, reward: 450, completed: false }
     ];
        ...
        const nextQs = qs.map(q => {
           if (q.type === type && !q.completed) {
              ...
              if (q.progress >= q.target) {
                 q.progress = q.target;
                 q.completed = true;
                 const reward = this.hasSkill('viral_referral') ? q.reward * 2 : q.reward;
                 this.synergy.update(s => s + reward);
                 this.spawnFloatingText("QUEST COMPLETE!", '#EAB308', this.player.x, this.player.y - 40);
                 this.addLog(`Challenge completed: ${q.desc}. Bonus Synergy +${reward}`, 'success');
              }
              updated = true;
           }
           return q;
  ...
  fakeEmpathy() {
    ...
    this.teamMorale.update(m => Math.min(100, m + 10));
    this.busyness.update(b => Math.min(100, b + 5));
    this.addLog("Offered fake empathy to a struggling team member. They feel heard, you look like a great leader.", 'success');
  }

  approveExpenseReport() {
    this.runStats['approveExpenseReport'] = (this.runStats['approveExpenseReport'] || 0) + 1;
    this.synergy.update(s => s + (10 * this.comboMultiplier));
    this.teamMorale.update(m => Math.max(0, m - 15));
    this.addCombo(20);
    this.addLog("Approved an expense report without reading it. Synergy increased due to your 'trust' in the team.", 'info');
  }

  togglePause() {
    if (this.gameState() === 'gameover' || this.gameState() === 'menu' || this.gameState() === 'story') return;
  ...
  retire() {
     ...
     this.totalSynergy.update(s => {
        ...
        if (typeof window !== 'undefined') localStorage.setItem('corp_meta_synergy', next.toString());
        return next;
     });
     this.lifetimeEarnedSynergy.update(s => {
        const next = s + runScore;
        if (typeof window !== 'undefined') localStorage.setItem('corp_meta_lifetime', next.toString());
        return next;
     });
  ...
  triggerFired(reason = "FIRED! 🛑 Caught doing ACTUAL WORK! Executives don't do real work.") {
     const runScore = this.synergy();
     this.totalSynergy.update(s => {
        const next = s + runScore;
        if (typeof window !== 'undefined') localStorage.setItem('corp_meta_synergy', next.toString());
...
\nI challenge you to beat my performance metrics directly. See you at the top. :handshake:`;
  ...
  downloadReviewCard() {
    ...
    this.spawnFloatingText("EXPORTING...", '#06B6D4', this.player.x, this.player.y);
    
    htmlToImage.toJpeg(node, { quality: 0.95, backgroundColor: '#0A101D' })
      .then((dataUrl) => {
        const link = document.createElement('a');
        link.download = 'Corporate_Performance_Review.jpeg';
        link.href = dataUrl;
        link.click();
        this.addLog("Performance Review Card downloaded successfully! Share it to your network.", "success");
      })
      .catch((error) => {
  ...
  shareToSlack() {
     ...
     navigator.clipboard.writeText(post).then(() => {
        alert("Slack/Teams format copied to clipboard! Paste it directly into your company chat.");
     }).catch(() => {
  ...
  exportIgStory() {
    ...
    this.spawnFloatingText("GENERATING STORY...", '#EC4899', this.player.x, this.player.y);
    ...
    footerText.innerText = "THINK YOU CAN BEAT MY SYNERGY?\nLINK IN BIO TO PLAY";
    ...
    htmlToImage.toJpeg(wrapper, { quality: 0.95, width: 1080, height: 1920, backgroundColor: '#060B14' })
      .then((dataUrl) => {
        const link = document.createElement('a');
        link.download = 'Corporate_Ladder_IG_Story.jpeg';
        link.href = dataUrl;
        link.click();
        this.addLog("IG Story exported! Upload it to your Instagram or TikTok.", "success");
      })
      .catch((error) => {
        console.error('Oops, something went wrong!', error);
  ...
  copyForInstagram() {
     ...
     navigator.clipboard.writeText(post).then(() => {
        alert("Downloaded 9:16 Story Image! Caption text also copied to clipboard.");
     }).catch(() => {
        // do nothing
     });
  }
  ...
  bribeTheDev() {
     if (this.synergy() >= 10000) {
        ...
        this.addLog("Bribed HR effectively (-10k). 'Records updated'. Wait, you still have to play to level up.", "success");
        this.createConfetti();
        this.playSound('levelUp');
     } else {
        this.addLog("You tried to Bribe HR, but you're too poor. Need 10,000 Synergy.", "error");
     }
  }
  ...
  firePinkSlip() {
    ...
    this.addLog("Fired a pink slip out of nowhere. 'Re-org' energy underway.", "warning");
    this.updateQuest('fire_cause');
  }
  ...
  onCanvasClick(e: MouseEvent | TouchEvent) {
    ...
    const scale = Math.max(rect.width / this.canvasRef.nativeElement.width, rect.height / this.canvasRef.nativeElement.height);
    const offsetY = (scale * this.canvasRef.nativeElement.height - rect.height) / 2;
  ...
  gaslightTeam() {
     ...
     this.addLog("Gaslit the entire department. Obstacles 'resolved' magically.", "success");
     ...
     let cleared = 0;
     for (const obs of this.obstacles) {
        if (obs.x > this.player.x - 100 && obs.x < this.canvasRef.nativeElement.width) {
           if (!obs.collected) {
              obs.collected = true;
              this.synergizeEffects.push({x: obs.x + obs.width/2, y: obs.y + obs.height/2, radius: 20, alpha: 1});
              cleared++;
           }
        }
     }
  ...
  synergizeEmail(obs: Obstacle) {
    ...
    this.addLog("Swiped away an Urgent Email. Handled it like a pro.", 'success');
    this.updateQuest('emails');
    this.updateQuest('inbox_zero');
    this.playSound('synergize');
    this.triggerHaptic(50);
    this.synergizeEffects.push({x: this.player.x + this.player.width/2, y: this.player.y + this.player.height/2, radius: 10, alpha: 1});
  }

  @HostListener('window:keydown.space', ['$event'])
  onSpaceDown(e: Event) {
    if ((e.target as HTMLElement).tagName !== 'BUTTON' && (e.target as HTMLElement).tagName !== 'INPUT' && (e.target as HTMLElement).tagName !== 'TEXTAREA' && (e.target as HTMLElement).tagName !== 'A') {
      e.preventDefault();
      if (!this.isPaused && this.gameState() === 'playing') {
  ...
  gameLoop() {
    if (!this.isPaused && (this.gameState() === 'playing' || this.gameState() === 'story')) {
  ...
  drawWorker(obs: Obstacle, scale: number) {
    ...
    this.ctx.lineTo(px + pWidth * 0.9, py + pHeight * 0.6 + Math.sin(walkTime) * 5);
    this.ctx.stroke();
    ...
    this.ctx.lineTo(px + pWidth * 0.7 + Math.sin(walkTime) * legStride * scale, py + pHeight);
    // Left leg (front)
    this.ctx.moveTo(px + pWidth * 0.3, py + pHeight * 0.6);
    this.ctx.lineTo(px + pWidth * 0.3 - Math.sin(walkTime) * legStride * scale, py + pHeight);
    this.ctx.stroke();
    ...
    if (this.ctx.roundRect) {
       this.ctx.beginPath();
       this.ctx.roundRect(px + pWidth * 0.1, py + headRadius * 1.5, pWidth * 0.8, pHeight * 0.5, 4);
       this.ctx.fill();
    } else {
       this.ctx.fillRect(px + pWidth * 0.1, py + headRadius * 1.5, pWidth * 0.8, pHeight * 0.5);
    }
  ...
  update() {
    ...
    const levelParams = Object.keys(STORY_EVENTS).map(k => parseInt(k)).sort((a,b) => a-b);
    for (const threshold of levelParams) {
      if (this.synergy() >= threshold && !this.promotionsClaimed.has(threshold)) {
         ...
         this.playSound('levelUp');
         this.createConfetti();
         this.trackAnalytics('promotion', { new_level: threshold, current_title: this.currentTitle() });
      }
    }
    ...
    if (this.hasSkill('marketing_buzz') && this.frameCount % 60 === 0 && !this.isFrozen) {
    ...
    for (let i = this.blocks.length - 1; i >= 0; i--) {
      ...
      if (b.active && 
          this.player.x < b.x + b.width && this.player.x + this.player.width > b.x &&
          this.player.y < b.y + b.height && this.player.y + this.player.height > b.y) {
          ...
          if (this.player.vy < 0 && this.player.y > b.y + (b.height / 2)) {
              ...
              this.addLog(`Bootlicked upper management successfully! +${points} Synergy`, "success");
    ...
    if (this.frameCount % spawnRate === 0) {
      ...
      if (isHurdle) {
        ...
        action = this.GAME_ACTIONS[Math.floor(Math.random() * this.GAME_ACTIONS.length)];
      ...
      const isAirborne = !isHurdle && Math.random() > 0.5;
      const originY = isAirborne ? this.groundLevel - 60 - Math.random() * 40 : this.groundLevel - height;
    ...
    for (let i = this.obstacles.length - 1; i >= 0; i--) {
        ...
        if (obs.action.type !== 'urgentEmail') {
           ...
           if (obs.isHurdle) {
              if (obs.action.type === 'redTape') {
                  ...
                  this.teamMorale.update(m => Math.max(0, m - 15));
                  this.screenShake = 8;
                  this.spawnFloatingText("MICROMANAGED!", '#7C3AED', obs.x, obs.y - 20);
                  this.addLog("A micromanager asked for a TPS report. Morale plummeted.", 'warning');
              } else if (obs.action.type === 'endlessMeeting') {
                  this.busyness.update(b => Math.min(100, b + 20));
                  this.teamMorale.update(m => Math.max(0, m - 5));
                  this.screenShake = 4;
                  this.spawnFloatingText("BORED!", '#3B82F6', obs.x, obs.y - 20);
                  this.addLog("Trapped in an endless alignment meeting.", 'warning');
              } else {
                  this.triggerFired();
              }
           } else {
      ...
      for (let j = this.projectiles.length - 1; j >= 0; j--) {
        ...
        if (obs.isHurdle && obs.action.type === 'realWork' && !obs.collected &&
            ...
            this.firedEffects.push({ x: obs.x + obs.width/2, y: obs.y + obs.height/2, scale: 0.2, alpha: 1.0 });
            this.playSound('fire');
            this.addLog(`Fired the ${obs.action.text} doer! Cleaned house efficiently.`, "success");
            this.updateQuest('fire');
    ...
    if (this.activeRoom() && this.frameCount % 90 === 0) {
       this.fb.updateRoomPlayer(this.activeRoom()!.roomId, this.synergy(), 'playing');
    }
  }
  ...
  draw() {
    ...
    for (let i = 0; i < canvas.width; i += 100) {
       ...
       const ly = 100 + Math.abs(Math.sin((i + this.frameCount * 0.01) * 0.5) * 150);
    ...
    const isIdle = pr.grounded && !this.obstacles.some(o => o.x > pr.x - 50 && o.x < pr.x + 300);
    let idleAnim = 0;
    if (isIdle) {
    ...
    if (pr.isJumping) {
      ...
      this.ctx.moveTo(bodyX + bodyWidth, bodyY + 5 * scale);
      this.ctx.lineTo(bodyX + bodyWidth + 5 * scale, bodyY + bodyHeight * 0.8 - Math.sin(time) * 10 * scale);
    }
    this.ctx.stroke();
    ...
    this.ctx.lineTo(bodyX + bodyWidth * 0.7 + (pr.grounded ? -Math.sin(time) * 15 * scale : 5 * scale), bodyY + bodyHeight + legLength);
    this.ctx.moveTo(bodyX + bodyWidth * 0.3, bodyY + bodyHeight);
    this.ctx.lineTo(bodyX + bodyWidth * 0.3 + (pr.grounded ? Math.sin(time) * 15 * scale : -10 * scale), bodyY + bodyHeight + legLength);
    this.ctx.stroke();
    ...
    if (!pr.isJumping) {
      ...
      if (idleAnim === 1) {
         ...
         this.ctx.stroke();
         this.ctx.fillStyle = '#1E293B';
         this.ctx.fillRect(bodyX + 10 * scale, bodyY + bodyHeight * 0.2, 5 * scale, 8 * scale);
      } else if (idleAnim === 2) {
         // Checking watch
         ...
         this.ctx.fillRect(bodyX + 4 * scale, bodyY + bodyHeight * 0.48, 4 * scale, 4 * scale);
      } else {
         ...
         this.ctx.fillRect(handX - 2 * scale, handY - 3 * scale, 6 * scale, 3 * scale);
      }
    } else {
       ...
       this.ctx.fillRect(bodyX - 10 * scale, bodyY + 20 * scale, 4 * scale, 2 * scale);
       this.ctx.fillRect(bodyX - 20 * scale, bodyY + 30 * scale, 8 * scale, 2 * scale);
    }

    // Collar
    this.ctx.fillStyle = shirtColor;
    this.ctx.fillRect(bodyX + bodyWidth*0.2, bodyY, bodyWidth*0.6, 4*scale);
    ...
    for (const obs of this.obstacles) {
      ...
      this.ctx.shadowColor = obs.isHurdle ? 'rgba(239, 68, 68, 0.4)' : 'rgba(139, 92, 246, 0.4)';
      ...
      this.ctx.strokeStyle = obs.isHurdle ? '#EF4444' : '#A855F7';
      this.ctx.lineWidth = 2;
      this.ctx.stroke();
      ...
      this.ctx.textAlign = 'center';
      this.ctx.textBaseline = 'middle';
      this.ctx.fillText(obs.action.icon, obs.x + obs.width/2, obs.y + obs.height/2 + 2);
    ...
    if (this.comboMeter > 0) {
       ...
       this.ctx.fillStyle = this.comboMultiplier >= 3 ? '#D946EF' : (this.comboMultiplier >= 2 ? '#A855F7' : '#38BDF8');
  ...
  buySkill(skill: SkillNode) {
    ...
    const depsMet = skill.dependencies.every(d => this.unlockedSkills().includes(d));
    if (!depsMet) return;
    ...
    this.unlockedSkills.update(skills => {
      ...
      if (typeof window !== 'undefined') {
          localStorage.setItem('corp_meta_synergy', this.totalSynergy().toString());
